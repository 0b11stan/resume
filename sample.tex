...
\tagline{Consultant en sécurité offensive ethique}
...
\cvevent{Consultant cybersécurité}{Capgemini}{Octobre 2021 -- Ongoing}{Pessac, Bordeaux}
\begin{itemize}
\item Audit d'une solution WAF pour une certification CSPN
\item Tests d'intrusion externes et interne
\end{itemize}
...
\cvevent{HelloAsso}{Développeur DevOps}{Sept. 2017 -- Sept. 2018}{Bordeaux (Darwin)}
\begin{itemize}
...
\cvevent{Master Spécialisé Sécurité Informatique}{ENSEEIHT}{Sept. 2020 -- Sept. 2021}{}
